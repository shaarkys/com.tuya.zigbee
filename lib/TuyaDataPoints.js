...
const V2_SOIL_SENSOR_DATA_POINTS = {
    soilMoisture: 3, // integer | 0-100 %
    temperature: 5, // integer | temperature (0.1 degC resolution)
    displayUnit: 9, // enum | 0: Celsius, 1: Fahrenheit
    batteryPercentage: 15, // integer | 0-100 %
    ...
    dryAlarm: 106, // boolean | 1: water shortage
