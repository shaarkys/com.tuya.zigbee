...
// Data points for Soil Sensor devices, version 2
const V2_SOIL_SENSOR_DATA_POINTS = {
    dryAlarm: 1, // boolean | true when soil is reported as dry
    soilMoistureCalibration: 102, // integer | -30..30 %
    temperature: 103, // integer | temperature (0.1 degC resolution)
    temperatureCalibration: 104, // integer | -2..2 degC (0.1 degC resolution)
    humidityCalibration: 105, // integer | -30..30 %
    displayUnit: 106, // enum | 0: Celsius, 1: Fahrenheit
    soilMoisture: 107, // integer | 0-100 %
    batteryPercentage: 108, // integer | 0-100 %
    humidity: 109, // integer | 0-100 %
    alarmSoilMoistureMin: 110, // integer | 0-100 %
    temperatureSampling: 111, // integer | seconds (5-3600)
    soilMoistureSampling: 112 // integer | seconds (5-3600)
};
